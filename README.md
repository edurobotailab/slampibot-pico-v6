...
## e-Manual for SlamPiBot-V6
- [e-Manual for SlamPiBot-V6](http://erail.gitbook.io/edurobotailab/)

## Open Sources related to SlamPiBot-V6
- [SlamPiBot-Foxy-V6](https://github.com/edurobotailab/slampibot-foxy-v6.git)
- [SlamPiBot-Pico-V6](https://github.com/edurobotailab/slampibot-pico-v6.git)
